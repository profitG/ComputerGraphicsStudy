...
const FLOWER_MODEL_PATHS = [
    {
      path: "./LowpolyModel/flower/scene.gltf",
      scale: 0.05,
    },
  ];
...
export class FLOWER{
    ...
    _createModel(){
        // 랜덤한 모델 선택
        const randomModelIndex = Math.floor(Math.random() * FLOWER_MODEL_PATHS.length);
        const selectedModel = FLOWER_MODEL_PATHS[randomModelIndex];
